    ...
    return (
      <section id="matches" className="py-16 px-4 bg-white">
        <div className="container mx-auto max-w-6xl text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Upcoming Matches</h2>
          <div className="inline-block bg-green-50 border border-green-200 rounded-xl px-8 py-6">
            <p className="text-lg font-semibold text-green-700">All matches are complete!</p>
            <p className="text-gray-500 mt-1">Check out the results below or relive the highlights.</p>
          </div>
        </div>
      </section>
    );
