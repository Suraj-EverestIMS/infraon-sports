    ...
    <div className="login-wrapper">
      ...
      <div className="flex items-center flex-col gap-3 justify-center">
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-6 py-3 hover:bg-gray-300 disabled:opacity-50"
        >
          <svg
            className="w-[18px]"
            viewBox="-3 0 262 262"
        ...
        <a
          ...
          className="w-full px-6 py-3 text-white rounded-lg flex items-center text-center gap-2 justify-center"
        >
          Way to Tournament
          <LogIn size={18} />
        </a>
